function build_model_no_terminal_hard_soc_test(gensets, load, battery, initial_commitment)
    ...
    @variable(model, battery.SOC_min * battery.E_max <= E[t in 1:length(load)+1] <= battery.SOC_max * battery.E_max)
